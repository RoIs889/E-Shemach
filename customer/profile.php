...
$query = "SELECT * FROM `customer` WHERE `Name` = '$v' ";
...
<body>
    ...
    <div class="sidebar">
        <div class="logo-details">
            ...
            <span class="logo_name">Customer Profile</span>
        </div>
        <ul class="nav-links">
            <li>
            ...
            <?php while ($rows = mysqli_fetch_assoc($result)) { ?>
                ...
                <div class="bar">
                    ...
                    <div class="profile2">Photo
                        <?php echo "<img width = 150px height = 160px object-fit = cover src='../clerks_manager/uploads/" . $image . "'>"; ?>
                    </div>
                    <div class="profile3">Kebelle_Id
                        <?php echo "<img width = 280px height = 160px object-fit = cover src='../clerks_manager/uploads/" . $kebelle_id . "'>"; ?>
                    </div>
