...
<header Id="header">
        ...
        <a href="register-employee.php"><button class="buttons"><i class="fa-solid fa-user-tie"></i> Register Employees</button></a>
        <a href="report.php"><button class="buttons"><i class="fa-solid fa-user-gear"></i> Reports</button></a>
        <a href="../index1.php"><button class="buttons"><i class="fa-solid fa-arrow-right-to-bracket"></i> Logout</button></a>
